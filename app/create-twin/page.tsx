    ...
    <div className="min-h-screen py-10 px-4 relative overflow-hidden" style={{ background: 'var(--bg-primary)' }}>
      ...
      <div className="relative z-10 max-w-2xl mx-auto">
        ...
        <div className="text-center mb-8 slide-up">
          ...
          <p className="text-sm mb-3" style={{ color: 'var(--text-secondary)' }}>The more you share, the smarter your twin becomes</p>
          {/* Back to dashboard if already have a twin */}
          <div className="flex items-center justify-center gap-3">
            <button
              type="button"
              onClick={() => router.push('/dashboard')}
              className="text-xs px-4 py-1.5 rounded-full font-medium transition-all hover:scale-105"
            ...
            <button
              ...
              onClick={() => {
                setForm({
                  name: 'Atul Jha', age: '22', occupation: 'Software Engineer',
                  primaryGoal: 'Win the Bot to Agent Hackathon with a flawless demo', secondaryGoals: 'Learn advanced AI agent design, build a robust extension', timeline: '1 month', biggestObstacle: 'Perfectionism and getting stuck on minor CSS bugs',
                  morningRoutine: 'Wake up, check emails, start coding by 9 AM', eveningHabits: 'Review pull requests, watch tech YouTube, sleep at 1 AM', procrastinationTriggers: 'When a bug is too hard to track down, or I am waiting for builds', distractions: 'YouTube, Twitter, Reddit',
                  workStyle: 'Deep work (long sessions)', productivityPeaks: 'Late night 11pm-2am', focusDuration: '90+ mins', learningStyle: 'Building projects',
                  strengths: 'Fast learner, creative problem solver, good at full-stack development', weaknesses: 'Overthinking, ignoring breaks, scope creep', motivationType: 'Desire for success', stressResponse: 'Work harder'
                });
                setStep(5);
              }}
              className="text-xs px-4 py-1.5 rounded-full font-medium transition-all hover:scale-105"
              style={{ background: 'linear-gradient(135deg,var(--green),var(--cyan))', color: 'white', border: 'none', boxShadow: '0 4px 10px rgba(16,185,129,0.3)' }}
            >
              ✨ Fill Demo Data
            </button>
          </div>
