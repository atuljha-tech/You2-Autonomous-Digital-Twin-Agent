...
export default function Dashboard() {
  ...
  if (loading) return <div className="min-h-screen pt-6 px-4 md:px-6"><DashboardSkeleton /></div>;
  if (error) return <div className="min-h-screen pt-12 px-4 md:px-6"><ErrorState onRetry={fetchData} message="Could not load your twin profile." /></div>;
  if (!user) return null;
  ...
  return (
    <div className="min-h-screen pt-6 px-4 md:px-6 relative">
      {/* Header */}
