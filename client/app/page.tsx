    ...
    <>
      ...
      <div style={{ position: 'fixed', inset: 0, width: '100vw', height: '100vh', overflow: 'hidden', fontFamily: 'Inter, -apple-system, BlinkMacSystemFont, "Segoe UI", sans-serif', WebkitFontSmoothing: 'antialiased' } as React.CSSProperties}>
        ...
        <nav style={{
          ...
          padding: 'clamp(1.5rem,3vw,2rem) clamp(1.25rem,5vw,5rem) 0',
        }}>
          {/* Logo */}
          <svg width="32" height="32" viewBox="0 0 256 256" fill="white" style={{ flexShrink: 0 }} aria-label="You²">
            <path d={LOGO_PATH} />
          </svg>
          ...
          <div
            ...
            style={{ ...lg, borderRadius: '9999px', padding: '.75rem 2rem', display: 'flex', gap: '2rem', alignItems: 'center' }}
          >
            <GradientBorder />
            <a href="#" className="lg-nav-link lg-nav-link-active">Home</a>
            <a href="#" className="lg-nav-link">Our Approach</a>
            <a href="#" className="lg-nav-link">Healing Methods</a>
          </div>
          ...
          <div className="lg-desktop-only" style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
            <Link
              href="/dashboard"
              style={{ ...lg, borderRadius: '9999px', padding: '.6rem 1.25rem', fontSize: '.8rem', fontWeight: 500, color: 'white', textDecoration: 'none', display: 'inline-flex', alignItems: 'center', gap: '.4rem' }}
            >
              <GradientBorder />
              Dashboard →
            </Link>
            <div style={{ ...lg, borderRadius: '9999px', width: 40, height: 40, display: 'flex', alignItems: 'center', justifyContent: 'center', cursor: 'pointer' }}>
              <GradientBorder />
              <CircleUserRound size={20} color="rgba(255,255,255,0.8)" strokeWidth={1.5} />
            </div>
          </div>
          ...
          <button
            ...
            style={{ ...lg, borderRadius: '9999px', width: 40, height: 40, border: 'none', cursor: 'pointer', zIndex: 50, padding: 0, display: 'flex', alignItems: 'center', justifyContent: 'center' }}
          >
            <GradientBorder />
